...
/* ==========================================================
   CATEGORY SYSTEM AUTO INITIALIZATION
========================================================== */
...
console.log(
    "📂 Part 7/8 — Category, Sub-category & Slider System Loaded."
);
        ...
        functionName => {
            ...
            if (
                ...
                try {
                    ...
                    console.warn(
                        `⚠️ Function validation skipped: ${functionName}`
                    );
